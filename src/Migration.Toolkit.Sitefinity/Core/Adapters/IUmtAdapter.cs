...
{
    /// <summary>
    /// Adapts <typeparamref name="TSourceModel"/> to IUmtModel
    /// </summary>
...
/// <summary>
/// Adapter for adapting Sitefinity models to UMT models with dependencies
/// </summary>
/// <typeparam name="TSourceModel">ISitefinityModel used in providers</typeparam>
/// <typeparam name="TDependenciesModel">IImportDependencies used to pass dependent objects used in adapter</typeparam>
internal interface IUmtAdapterWithDependencies<in TSourceModel, in TDependenciesModel> where TSourceModel : ISitefinityModel where TDependenciesModel : IImportDependencies
{
    /// <summary>
    /// Adapts <typeparamref name="TSourceModel"/> to IUmtModel
    /// </summary>
